...
public class ProductService {
    ...
    public ProductService(){
        ...
        createProduct(new Product("Purple Alien Hoodie", "This cozy purple hoodie is made from soft, high-quality material that will keep you warm and comfortable. The vibrant shade of purple adds a pop of color to your wardrobe, while the relaxed fit and kangaroo pocket make it perfect for everyday wear. The drawstring hood allows for adjustable coverage, and the ribbed cuffs and hem provide a secure and snug fit. Whether you're lounging at home or out and about, this stylish and comfortable hoodie is sure to become a go-to in your wardrobe.", 80.00f, null, "assets/img/alienSudadera2Sin.png"));
        createProduct(new Product("Black Alien Hoodie", "This sleek black hoodie is a versatile addition to your wardrobe. Made from a soft and cozy material, it features a comfortable and relaxed fit that's perfect for everyday wear. The black color gives it a timeless and sophisticated look that can be dressed up or down. The hoodie also comes with a drawstring that allows you to adjust the fit for optimal coverage. The kangaroo pocket provides a convenient place to store your phone or other small essentials. Whether you're running errands or going out with friends, this black hoodie is sure to keep you stylish and comfortable.", 80.00f, null, "assets/img/alienSudadera3Sin.png"));
    }
    ...
    public Product getProduct(int id) {
        if (this.products.containsKey(id - 1)) {
